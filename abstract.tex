...
\multirow{2}{*}{Title} & \multicolumn{3}{c|}{\multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}Neural network topological expressiveness\\ Understanding neural network behaviour problem independently\end{tabular}}} \\
