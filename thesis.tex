...
\tcbox[title=$\R P^2$]{
  \begin{tikzpicture}[node distance={10mm}] 
    ...
    \node[draw=none, label=below:{0}] (5) [below left of=2] {}; 
    \node[draw=none, label=below:{2}] (6) [below right of=3] {}; 
    \node[draw=none, label={1}] (7) [above right of=4] {}; 
    ...
    \node[draw=none, label={1}] (12) [above right of=11] {}; 
    \node[draw=none, label={2}] (13) [above left of=10] {}; 
    \node[draw=none, label=below:{0}] (14) [below left of=9] {}; 
\begin{scope}[very thick,decoration={
    markings,
    mark=at position 0.5 with {\arrow{latex}}}
    ] 
